...
?>
<!-- 		<article id="content" class="col-lg-8 col-md-8 " data-post-id="<?php the_ID(); ?>" role="article" itemscope itemtype="http://schema.org/Article"> -->
		<article id="content" class="" data-post-id="<?php the_ID(); ?>" role="article" itemscope itemtype="http://schema.org/Article">		
