		...
		<div id="content" class="col-lg-8 col-md-8 archive" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
			...
			<div class="<?php echo apply_filters('dmeng_archive_panel_class', 'panel panel-default panel-archive');?>">
				...
				<h1 class="h3 page-header panel-archive-title"><?php
					...
					?>
					<small> <span class="glyphicon glyphicon-list-alt"></span> <?php printf( '%s个相关结果', '<span itemprop="interactionCount">'.$wp_query->found_posts.'</span>' );?> <span class="glyphicon glyphicon-signal"></span> <?php printf( __( '%s次浏览', 'dmeng' ) , '<span data-num-views="true">'.get_dmeng_traffic($tracker['type'],$tracker['pid']).'</span>');?></small>
				</h1>
				<?php
