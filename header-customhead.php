...
<header id="masthead" itemscope itemtype="http://schema.org/WPHeader">
	...
	<div class="container-fluid subnav2-container">
	    <!-- <img src=""<?php echo get_bloginfo('template_url').'/images/index/star.png' ?>"" class="img-responsive img22" alt=""> -->
	    <div class="row">
	       <div class="col-md-6 h1-setting">
	        <h1 class="h1-set">信息工程学院</h1>
	        <h1 class="h1-set-English">College Of Information Engineering</h1>
	       </div>
	...
	<div class="navbar-inverse navbar-default navbar-static-top" role="banner">

		

		<div class="container">
<!-- 			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".header-navbar-collapse"><span class="sr-offnly"><?php _e('切换菜单','dmeng');?></span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
				<?php
